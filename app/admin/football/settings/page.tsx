...
export default function FootballSettingsPage() {
      ...
      <main className="flex-1 ml-64 overflow-auto bg-background">
        <div className="bg-card border-b border-border sticky top-0 z-10 px-8 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">Football Settings</h1>
              <p className="text-xs text-muted-foreground">Configure football tournament rules</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Manage football league settings and rules</p>
          </div>
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <input type="number" defaultValue="90" className="w-full px-3 py-2 bg-background border border-border rounded-lg" />
                </div>
                <div>
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Substitutions Allowed</label>
                  <input type="number" defaultValue="3" className="w-full px-3 py-2 bg-background border border-border rounded-lg" />
                </div>
              </CardContent>
            </Card>
