...
const TEAMS = [
  { id: 1, name: 'India', players: 15, wins: 42, losses: 18 },
  { id: 2, name: 'Australia', players: 15, wins: 38, losses: 22 },
  { id: 3, name: 'England', players: 15, wins: 35, losses: 25 },
];
        ...
        <main className="flex-1 overflow-auto bg-background">
          ...
          <div className="bg-gradient-to-r from-green-500/10 to-transparent border-b border-border px-8 py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Browse all cricket teams</p>
              </div>
            </div>
          </div>
          <div className="p-6 md:p-8 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {TEAMS.map((team) => (
                <Card key={team.id} className="bg-card border-border hover:border-green-600/50 transition">
