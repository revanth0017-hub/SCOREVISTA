...
export default function BasketballHighlightsPage() {
  return (
        ...
        <main className="flex-1 overflow-auto bg-background">
          ...
          <div className="p-8">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">Watch the best moments from recent matches</p>
            </div>
            <SportHighlightsList sport="basketball" />
          </div>
        </main>
      </div>
    </div>
