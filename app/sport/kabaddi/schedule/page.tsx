...
const MATCHES = [
  { id: 1, team1: 'Tigers', team2: 'Panthers', date: '2024-02-15', time: '6:00 PM', venue: 'Arena A' },
  { id: 2, team1: 'Warriors', team2: 'Hawks', date: '2024-02-16', time: '7:00 PM', venue: 'Arena B' },
  { id: 3, team1: 'Lions', team2: 'Falcons', date: '2024-02-17', time: '5:00 PM', venue: 'Arena A' },
];

export default function KabaddiSchedulePage() {
  return (
        ...
        <main className="flex-1 overflow-auto bg-background">
          ...
          <div className="bg-gradient-to-r from-pink-500/10 to-transparent border-b border-border px-8 py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">View all scheduled kabaddi matches</p>
              </div>
            </div>
          </div>
          <div className="p-6 md:p-8 max-w-7xl mx-auto">
            ...
            <div className="space-y-4">
              {MATCHES.map((match) => (
                <Card key={match.id} className="bg-card border-border hover:border-red-500/50 transition">
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-3">
                          <Badge className="bg-red-500/20 text-red-400">{match.date}</Badge>
