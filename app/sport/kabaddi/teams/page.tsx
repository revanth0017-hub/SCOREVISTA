...
const TEAMS = [
  { id: 1, name: 'Tigers', players: 12, wins: 8, losses: 2 },
  { id: 2, name: 'Panthers', players: 12, wins: 7, losses: 3 },
  { id: 3, name: 'Warriors', players: 12, wins: 6, losses: 4 },
];
        ...
        <main className="flex-1 overflow-auto bg-background">
          ...
          <div className="p-6 md:p-8 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {TEAMS.map((team) => (
                <Card key={team.id} className="bg-card border-border hover:border-red-500/50 transition">
