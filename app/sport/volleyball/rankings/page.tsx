...
const RANKINGS = [
  { rank: 1, team: 'Waves', played: 9, wins: 7, losses: 2, points: 14 },
  { rank: 2, team: 'Thunder', played: 9, wins: 6, losses: 3, points: 12 },
  { rank: 3, team: 'Eagles', played: 9, wins: 5, losses: 4, points: 10 },
];

export default function VolleyballRankingsPage() {
  return (
                      ...
                      {RANKINGS.map((entry) => (
                        <tr key={entry.rank} className="border-b border-border hover:bg-background/50 transition">
                          <td className="py-3 px-4 font-bold">
                            <Badge className="bg-orange-500/20 text-orange-400">#{entry.rank}</Badge>
                          </td>
