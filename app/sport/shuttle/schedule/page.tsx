...
const MATCHES = [
  { id: 1, team1: 'Falcons', team2: 'Eagles', date: '2024-02-15', time: '4:00 PM', venue: 'Court A' },
  { id: 2, team1: 'Hawks', team2: 'Sparrows', date: '2024-02-16', time: '5:00 PM', venue: 'Court B' },
  { id: 3, team1: 'Ravens', team2: 'Swallows', date: '2024-02-17', time: '6:00 PM', venue: 'Court A' },
];
        ...
        <main className="flex-1 overflow-auto bg-background">
          ...
          <div className="bg-gradient-to-r from-teal-500/10 to-transparent border-b border-border px-8 py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">View all scheduled badminton matches</p>
              </div>
            </div>
          </div>
          <div className="p-6 md:p-8 max-w-7xl mx-auto">
            ...
            <div className="space-y-4">
              {MATCHES.map((match) => (
                <Card key={match.id} className="bg-card border-border hover:border-teal-600/50 transition">
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-3">
                          <Badge className="bg-teal-600/20 text-teal-400">{match.date}</Badge>
